 ...
 * @return 'X' oder 'O', wenn ein Spieler gewonnen hat, sonst ' '.
 */
char checkWin(void);
...
/**
 * @brief Überprüft, ob der eingegebene Zug (Index) gültig ist.
 ...
 * @param mark Zeichen ('X' oder 'O').
 */
void makeMove(int move, char mark);

/**
 * @brief Gibt einen zufälligen, gültigen Zug für die KI zurück.
 * @return Index eines freien Feldes (0–8) oder -1, wenn keine Züge mehr möglich sind.
 */
int getAIMove(void);
