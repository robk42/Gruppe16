...
/**
 * @brief Zeigt eine Nachricht in der ncurses-Oberfläche an und wartet auf eine Tastatureingabe.
 * Diese Funktion kapselt reine UI-Aufrufe und trennt so die Präsentation von der Spiellogik.
